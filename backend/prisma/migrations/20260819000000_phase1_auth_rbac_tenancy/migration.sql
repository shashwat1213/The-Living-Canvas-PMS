...
-- CreateIndex
CREATE INDEX "property_access_property_id_idx" ON "property_access"("property_id");

-- CreateIndex
CREATE UNIQUE INDEX "property_access_user_id_property_id_key" ON "property_access"("user_id", "property_id");
...
-- AddForeignKey
ALTER TABLE "property_access" ADD CONSTRAINT "property_access_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "property_access" ADD CONSTRAINT "property_access_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE CASCADE ON UPDATE CASCADE;
